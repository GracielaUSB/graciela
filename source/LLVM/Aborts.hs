...
-- | Etiqueta usada para el caso en que el cuantificador para todo no se cumpla
...
-- | Etiqueta usada para el caso en que el cuantificador existencial no se cumpla
