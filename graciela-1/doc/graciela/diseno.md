...
* La aserción corresponde a la condición que se debe cumplir en un momento
...
* Los parámetros de entrada de los procedimientos tiene **cuatro*tipos de
...
* **Universal (**`forall`**):**  Es utilizado para verificar que todos los
